...
class PreprocessService:
    ...
    async def process_pdf_upload(self, file_id: UUID) -> str:
        ...
        try:
            ...
            response_data = await self.extraction_repo.get_extraction_with_file_info(
                file_id
            )
            ...
            for item in extraction_results:
                ...
                if use_existing:
                    ...
                    await self.extraction_repo.create_extraction_entry(
                ...
                if summary:
                    ...
                    try:
                        await self.relationship_service.detect_and_link(
                            file_id, summary
                        )
